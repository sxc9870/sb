...
import com.sxc.constants.SessionConstans;


@WebServlet(urlPatterns="*.images", description="Servlet的说明")
public class ValidateCodeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest reqeust, HttpServletResponse response)
        ...
        ValidateCode vCode = new ValidateCode(150, 40, 4, 80);
        session.setAttribute(SessionConstans.VALICODE, vCode.getCode());
        vCode.write(response.getOutputStream());
    }
    /**
     * web.xml 添加servlet
     * <servlet> <servlet-name>validateCodeServlet</servlet-name>
